...
% Tamlık bölümündeki maksimal tutarlı kümeler için gereken
% ispatlanabilirlik özellikleri.
...
\olref[fol][axd][prv]{prop:provability} önermesinin ispatını tamamlayın.
\end{probtag}
