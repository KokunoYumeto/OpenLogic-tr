% Generated from locale/tr/content/sets-functions-relations/size-of-sets/enumerability.tex; do not hand-edit.
...
\begin{explain}
Daha önce kümeleri, !!{element}s{}ını listeleyerek örneklemiştik. Şimdi bir
kümenin, sonsuz olsa bile, !!{element}s{}ını nasıl ve ne zaman
...
!!{element}s{}ından oluşan, sonlu ya da sonsuz ve $A$'nın her !!{element}{}ını
...
\item Yalnızca bir başlangıcı olan ve ilk !!{element} dışındaki her
  ...
  vb.'dir.
\item Aynı $A$ kümesinin, !!{element}s{}ın görünme sırasına göre farklılaşan
...
\begin{proof}
  ...
  !!{element}s{}ı çıkararak bir numaralandırmadaki tekrarları kaldırabiliriz.
...
Öte yandan, $A$'nın bütün !!{element}s{}ını numaralandıran bir liste
...
Bir kümenin !!{element}s{}ını listelerken saymaya ilk !!{element}{}dan başlamak
...
vb. !!{element}s{}ından söz ederler. Buna uygun olarak bir numaralandırmayı
...
Yukarıda $A$ kümesinin !!{element}s{}ından oluşan bir listenin tekrarsız bir listeye
...
!!{element}s{}ı bulunan ama aynı değeri iki kez almayan bir fonksiyonumuz
