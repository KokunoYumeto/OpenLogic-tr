% Generated from locale/tr/content/normal-modal-logic/sequent-calculus/proofs-in-K.tex; do not hand-edit.


\olfileid[tr]{nml}{seq}{prk}

\olsection{\Log{K} için Sekant \usetoken{P}{derivation}}

\iftag{prvBox}{

\begin{ex}
  $\Proves (\Box!A \land \Box!B) \lif \Box (!A \land !B)$ olduğunu
  gösteren bir sekant hesabı !!{derivation}{}i verelim.
  \begin{prooftree}
    \Axiom$!A \fCenter !A$
    \doubleLine
...
\iftag{prvDiamond}{
  \begin{ex}
    ...
    olduğunu gösteren bir sekant hesabı !!{derivation}{}i verelim.
    \begin{prooftree}
      \Axiom$!A \fCenter !A$
      \doubleLine
...
\iftag{notprvBox,notprvDiamond}{}{
  İşte~\Dual için bir !!a{derivation}.
  \begin{prooftree}
    \Axiom$!A \fCenter !A$
...
\begin{prob}
  Aşağıdaki !!{formula}s için $\Log{K}$ içinde sekant hesabı ispatları
  bulun:
  \begin{enumerate}
