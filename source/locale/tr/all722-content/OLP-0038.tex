% Generated from locale/tr/content/sets-functions-relations/size-of-sets/enumerability-alt.tex; do not hand-edit.
...
Sonlu bir kümeyi yalnızca !!{element}s{}ını numaralandırarak belirtebiliriz.
Şöyle bir küme tanımladığımızda bunu yaparız:
\[
  A = \{a_1, a_2, \ldots, a_n\}.
\]
$a_1$, \dots, $a_n$ !!{element}s{}ının birbirinden farklı olduğunu
...
!!{bijection} vardır; burada $n$, $A$'nın !!{element}s{}ının sayısıdır.
...
\begin{explain}
Öyleyse bir küme, ancak ve ancak boşsa ya da !!{element}s{}ı bir
