% Generated from locale/tr/content/first-order-logic/axiomatic-deduction/axioms-rules-propositional.tex; do not hand-edit.


\iftag{FOL}
      {\olfileid[tr]{fol}{axd}{prp}}
      {\olfileid[tr]{pl}{axd}{prp}}

\olsection{Önerme Bağlaçları için Aksiyomlar ve Kurallar}

\begin{defn}[Aksiyomlar]
Önerme bağlaçlarına ilişkin $\PAx$ \emph{aksiyomları} kümesi, aşağıdaki
biçimlerde verilen !!{formula}s kümesini kapsar:
\begin{align}
...
\begin{defn}[Modus ponens]
  $!B$ ile $!B \lif !A$ bir !!a{derivation} içinde daha önce geçiyorsa $!A$
