% Generated from locale/tr/content/normal-modal-logic/axioms-systems/more-proofs-in-K.tex; do not hand-edit.


\olfileid[tr]{nml}{prf}{mpr}

\olsection{\Log{K}'de Daha Fazla İspat}

Şimdi, \olref[der]{sec}'te tanıtılan sadeleştirilmiş yöntemi kullanarak
\Log{K}'de birkaç !!{derivability} örneğine daha bakalım.
...
5. &  $\Log{K} \Proves \Box(!A \lif !B) \lif (\Diamond!A \lif \Diamond!B)$ & $\lnot\Box\lnot$ yerine $\Diamond$.
\end{derivation}
\end{proof}
...
\begin{proof}
  ...
  \Diamond !B)$ & $\lnot\Box\lnot$ yerine $\Diamond$.
  \end{derivation}
\end{proof}
...
\begin{proof}
  \begin{derivation}
    ...
    $\lnot\Box\lnot$ yerine $\Diamond$\\
    5. & $\Log{K} \Proves \Diamond!B \lif \Diamond(!A \lor !B)$ & benzer biçimde\\
...
\begin{proof}
  \begin{derivation}
    ...
    \Diamond!B \lif \Diamond!A)$ & $\lnot\Box\lnot$ yerine $\Diamond$\\
    7. & $\Log{K} \Proves \Diamond(!A\lor!B) \lif (\Diamond!B \lor \Diamond!A)$ & \PL, 6. \\
  \end{derivation}
\end{proof}

\begin{prob}
  Aşağıdaki !!{derivability} iddialarının geçerli olduğunu gösterin:
  \begin{enumerate}
