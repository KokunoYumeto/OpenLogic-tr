% Generated from locale/tr/content/normal-modal-logic/tableaux/proofs-in-K.tex; do not hand-edit.


\olfileid[tr]{nml}{tab}{prk}

\olsection{\Log{K} için \usetoken{P}{tableau}}

\iftag{prvBox}{

\begin{ex}
  $\Proves (\Box!A \land \Box!B) \lif \Box (!A \land !B)$ olduğunu gösteren
...
\begin{ex}
  ...
  olduğunu gösteren kapalı bir tablo veriyoruz:
  \begin{oltableau}
...
\begin{prob}
  Aşağıdaki !!{formula}s için $\Log{K}$ içinde kapalı !!{tableau}s bulun:
  \begin{enumerate}
