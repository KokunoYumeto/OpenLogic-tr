% Generated from locale/tr/content/sets-functions-relations/size-of-sets/non-enumerability.tex; do not hand-edit.
...
göstermelisiniz. Bunu yapmanın en iyi yolu, $A$'nın !!{element}s{}ından oluşan
...
!!{element}s{}ından oluşan $x_1$, $x_2$, \dots{} biçiminde bir liste verildiğinde,
...
$\Bin^\omega$'nın bütün !!{element}s{}ından oluşan $s_1$, $s_2$, $s_3$,
...
üstteki sayılar ise tek tek dizilerin !!{element}s{}ını numaralandırır.
...
$\overline{s}$'yi tanımlamak için bütün !!{element}s{}ının ne olduğunu, yani
...
$\Bin^\omega$'nın !!{element}s{}ından oluşan bir $s_1$, $s_2$, \dots{}
...
$\Bin^\omega$'nın \emph{bütün} !!{element}s{}ından oluşan hiçbir listenin
...
olmadığından ve dolayısıyla $\overline{Z}$ ile $Z_k$ farklı !!{element}s{}a
