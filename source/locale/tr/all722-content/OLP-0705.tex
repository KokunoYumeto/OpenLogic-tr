% Generated from locale/tr/content/proof-theory/sequent-calculus/rules-G1i.tex; do not hand-edit.
...
\\[2ex]
\multicolumn{2}{@{}c@{}}{Yapısal Kurallar}\\[2ex]
...
\DisplayProof
\end{tabular}
\caption{Sezgici mantık için \Log{G1i} kuralları.
...
$\RightR{\Contraction}$ kuralı yoktur. \Log{G1m}, \Log{G1i}'den
~\RightR{\Weakening} kuralıyla $\lfalse,\Gamma\Sequent\Delta$
aksiyomlarının çıkarılmasıyla elde edilir.}
\ollabel{tab:G1i}
\end{table}
