% Generated from locale/tr/content/sets-functions-relations/size-of-sets/comparing-size.tex; do not hand-edit.
...
\oliflabeldef{sfr:siz:nen:thm:nonenum-pownat}{\olref{thm:cantor}'ın ispatını
  ...
  $\PosInt$ yerine $A$'nın !!{element}s{}ıdır. $\overline{A}$, her $x\in A$
...
\oliflabeldef{sfr:siz:nen-alt:thm:nonenum-pownat}{\olref{thm:cantor}'ın
  ...
  $\Nat$ yerine $A$'nın !!{element}s{}ıdır. $D$, her $x\in A$ için
