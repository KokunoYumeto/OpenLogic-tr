% Generated from locale/tr/content/sets-functions-relations/arithmetization/integers.tex; do not hand-edit.
...
İki temel gözlemle başlayalım:
	...
	\end{enumerate}
Doğal sayıların sıralı ikililerinin $\Nat^2$'nin !!{element}s{}ı olduğunu
