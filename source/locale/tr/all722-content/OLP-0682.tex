% Generated from locale/tr/content/proof-theory/proof-search/rules-Tc.tex; do not hand-edit.
...
\end{tabular}
\end{center}
\caption{$\Log{Tc}$ kuralları. $\TRule{\False}{\lforall}$ ve
$\TRule{\True}{\lexists}$ kurallarında !!{constant}~$a$, yukarıdaki dalda
bulunmamalı, yani dal için yeni olmalıdır.}
\ollabel{tab:Tc}
\end{table}
