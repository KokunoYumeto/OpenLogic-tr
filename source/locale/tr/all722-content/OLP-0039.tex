% Generated from locale/tr/content/sets-functions-relations/size-of-sets/non-enumerability-alt.tex; do not hand-edit.
...
$A$'nın !!{element}s{}ını numaralandırmaya yönelik her girişimin en az bir
...
kullanmaktır. $A$'nın !!{element}s{}ından oluşan $x_1$, $x_2$, \dots{}
...
\begin{proof}
$\Bin^\omega$'nın !!{element}s{}ından oluşan herhangi bir sonsuz listeyi düşünün.
...
$\Bin^\omega$'nın !!{element}s{}ından oluşan gelişigüzel bir sonsuz liste
verildiğinde, listenin $\Bin^\omega$'nın bazı !!{element}s{}ını
