% Generated from locale/tr/content/proof-theory/propositions-as-types/rules-tN2.tex; do not hand-edit.
...
\DisplayProof}
\end{tabular}
\caption{Terim etiketli önermesel sezgici doğal tümdengelim sistemi
$\Log{tN2ip}$'nin kuralları.}
\ollabel{tab:tN2ip}
\end{table}
