...
try {
    ...
    Copy-Item -LiteralPath "checkpoint-0062-tr.pdf" -Destination (Join-Path $OutputDirectory "00_OPENLOGIC_tr_CUMULATIVE_LINKED_READER_OLP-0062.pdf") -Force
} finally {
    Pop-Location
}

$pdf = Join-Path $OutputDirectory "00_OPENLOGIC_tr_CUMULATIVE_LINKED_READER_OLP-0062.pdf"
